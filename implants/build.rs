...
fn main() {
    ...
    let key = env::var_os("KEY").unwrap();
    let nonce = env::var_os("NONCE").unwrap();
    ...
    fs::write(
        &dest_path,
        format!("pub fn init() -> (&'static str, &'static str, u16, u64, &'static str, &'static str) {}
            (\"{}\", \"{}\", {}, {}, \"{}\", \"{}\")
        {}
        ",
        "{",
